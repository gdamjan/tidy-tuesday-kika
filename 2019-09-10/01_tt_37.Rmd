...
ggplot(data = tx_injuries) + 
  geom_histogram(mapping = aes(x = age, fill = gender), na.rm = TRUE) +
  labs(x="Години", y="Број") +
  labs(title="Број на повреди по години по пол", fill = "Пол") +
  theme_minimal()
#овде сакам да ги нема NA ? и како беше да се направи граница околу bin-овите?
```
...
```{r, echo=TRUE, eval=FALSE}
ggplot(data = tx_injuries) + 
  geom_point(mapping = aes(x = injury_date, y = age)) +
